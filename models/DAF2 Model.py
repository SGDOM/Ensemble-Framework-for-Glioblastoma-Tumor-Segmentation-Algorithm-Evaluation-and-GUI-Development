...
def unet_model_3d(loss_function, input_shape=(4, 160, 160, 16),
    ...
    conv3 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(pool3)
    ...
    up6 = Conv3DTranspose(256,(3, 3, 3),strides=(2, 2, 2),padding="same")(conv3)
    conv6 = attention_block(up6, conv32, 256)
    ...
    conv7 = attention_block(up7, conv2, 128)
    ...
    conv7 = attention_block(up8, conv1, 64)
    ...
    conv8=concatenate([conv8,out2,out1],axis = 1)
    conv8 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    conv8 = Conv3D(128, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    conv8 = Conv3D(64, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    #################### FIN DECODER #########################
